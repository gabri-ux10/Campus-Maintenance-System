...
export default function HeroSection() {
  return (
    <div className="relative w-full overflow-hidden bg-zinc-950 font-sans text-white">
      ...
      <div
        className="absolute inset-0 z-0 bg-[url('https://images.unsplash.com/photo-1518005020951-eccb494ad742?auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-40"
        style={{
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="space-y-6 lg:col-span-5 lg:mt-12">
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
              <div className="pointer-events-none absolute -mr-16 -mt-16 right-0 top-0 h-64 w-64 rounded-full bg-white/5 blur-3xl" />
                ...
                <div className="animate-marquee flex gap-12 whitespace-nowrap px-4">
                  {[...CLIENTS, ...CLIENTS, ...CLIENTS].map((client, i) => {
                    ...
                    return (
                      <div
                        key={`${client.name}-${i}`}
                        className="flex cursor-default items-center gap-2 opacity-50 transition-all hover:scale-105 hover:opacity-100 hover:grayscale-0 grayscale"
                      >
